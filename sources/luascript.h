...
class LuaScriptInterface
{
	...
	protected:
		...
		//lua functions
		static int32_t luaGetFrags(lua_State* L);
		static int32_t luaSetFrags(lua_State* L);
		static int32_t luaGetDeaths(lua_State* L);
		static int32_t luaSetDeaths(lua_State* L);
		static int32_t luaGetAssists(lua_State* L);
		static int32_t luaSetAssists(lua_State* L);

		static int32_t luaGetTmpFrags(lua_State* L);
		static int32_t luaSetTmpFrags(lua_State* L);
		static int32_t luaGetTmpDeaths(lua_State* L);
		static int32_t luaSetTmpDeaths(lua_State* L);
		static int32_t luaGetTmpAssists(lua_State* L);
		static int32_t luaSetTmpAssists(lua_State* L);

		static int32_t luaGetLastFrags(lua_State* L);
		static int32_t luaSetLastFrags(lua_State* L);
		static int32_t luaGetLastAssists(lua_State* L);
		static int32_t luaSetLastAssists(lua_State* L);
		...
		static int32_t luaDoPlayerSetTarget(lua_State* L);
		...
		static int32_t luaSetPlayerModes(lua_State* L);
		static int32_t luaLoadPlayer(lua_State* L);
...
#endif
		static int32_t luaGetTime(lua_State* L);
